...
def run_suite():
    ...
    # 6. Europe PMC (Literature & Machine-Mined Annotations)
    results.append(test_endpoint("Europe PMC", 
        "https://www.ebi.ac.uk/europepmc/webservices/rest/search?query=Giredestrant&format=json&pageSize=1"))
