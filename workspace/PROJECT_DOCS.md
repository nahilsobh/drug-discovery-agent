...
- **`run_research_intelligence.py`**: Conducts real-time literature synthesis using ArXiv and Semantic Scholar.
- **`EXECUTIVE_DASHBOARD.md`**: The final strategic verdict for the CEO.

## 📈 Key 2026 Findings
- **Highest Velocity:** CT-388 (Obesity) - 22.5% weight loss signal.
- **Top Breakthrough:** Trontinemab (Alzheimer's) - 92% amyloid clearance in 28 weeks.
